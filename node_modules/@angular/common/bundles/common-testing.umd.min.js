...
/*! *****************************************************************************
    ...
    ***************************************************************************** */a.decorators=[{type:e.Injectable}],a.ctorParameters=function(){return[]};var h=function h(t){this.newUrl=t,this.pop=!0,this.type="popstate"},p=/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/,u=new e.InjectionToken("MOCK_PLATFORM_LOCATION_CONFIG"),c=function(){function t(t){if(this.baseHref="",this.hashUpdate=new r.Subject,this.urlChanges=[{hostname:"",protocol:"",port:"",pathname:"/",search:"",hash:"",state:null}],t){this.baseHref=t.appBaseHref||"";var e=this.parseChanges(null,t.startUrl||"http://<empty>/",this.baseHref);this.urlChanges[0]=Object.assign({},e)}}return Object.defineProperty(t.prototype,"hostname",{get:function(){return this.urlChanges[0].hostname},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"protocol",{get:function(){return this.urlChanges[0].protocol},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"port",{get:function(){return this.urlChanges[0].port},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"pathname",{get:function(){return this.urlChanges[0].pathname},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"search",{get:function(){return this.urlChanges[0].search},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"hash",{get:function(){return this.urlChanges[0].hash},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"state",{get:function(){return this.urlChanges[0].state},enumerable:!1,configurable:!0}),t.prototype.getBaseHrefFromDOM=function(){return this.baseHref},t.prototype.onPopState=function(t){return function(){}},t.prototype.onHashChange=function(t){var e=this.hashUpdate.subscribe(t);return function(){return e.unsubscribe()}},Object.defineProperty(t.prototype,"href",{get:function(){return this.protocol+"//"+this.hostname+(this.port?":"+this.port:"")+("/"===this.pathname?"":this.pathname)+this.search+this.hash},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"url",{get:function(){return""+this.pathname+this.search+this.hash},enumerable:!1,configurable:!0}),t.prototype.parseChanges=function(t,e,n){return void 0===n&&(n=""),t=JSON.parse(JSON.stringify(t)),Object.assign(Object.assign({},function r(t,e){var n,r;/^((http[s]?|ftp):\/\/)/.test(t)||(n="http://empty.com/");try{r=new URL(t,n)}catch(i){var s=p.exec(n||""+t);if(!s)throw new Error("Invalid URL: "+t+" with base: "+e);var o=s[4].split(":");r={protocol:s[1],hostname:o[0],port:o[1]||"",pathname:s[5],search:s[6],hash:s[8]}}return r.pathname&&0===r.pathname.indexOf(e)&&(r.pathname=r.pathname.substring(e.length)),{hostname:!n&&r.hostname||"",protocol:!n&&r.protocol||"",port:!n&&r.port||"",pathname:r.pathname||"/",search:r.search||"",hash:r.hash||""}}(e,n)),{state:t})},t.prototype.replaceState=function(t,e,n){var r=this.parseChanges(t,n),s=r.pathname,o=r.search,i=r.state,a=r.hash;this.urlChanges[0]=Object.assign(Object.assign({},this.urlChanges[0]),{pathname:s,search:o,hash:a,state:i})},t.prototype.pushState=function(t,e,n){var r=this.parseChanges(t,n),s=r.pathname,o=r.search,i=r.state,a=r.hash;this.urlChanges.unshift(Object.assign(Object.assign({},this.urlChanges[0]),{pathname:s,search:o,hash:a,state:i}))},t.prototype.forward=function(){throw new Error("Not implemented")},t.prototype.back=function(){var t=this,e=this.url,n=this.hash;this.urlChanges.shift(),n!==this.hash&&function r(t){Promise.resolve(null).then(t)}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */c.decorators=[{type:e.Injectable}],c.ctorParameters=function(){return[{type:void 0,decorators:[{type:e.Inject,args:[u]},{type:e.Optional}]}]},t.MOCK_PLATFORM_LOCATION_CONFIG=u,t.MockLocationStrategy=a,t.MockPlatformLocation=c,t.SpyLocation=s,Object.defineProperty(t,"__esModule",{value:!0})}));